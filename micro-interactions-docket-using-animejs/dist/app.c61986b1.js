...
function flatten(array) {
  ...
  return (_a = []).concat.apply(_a, (0, _tslib.__spreadArray)([], (0, _tslib.__read)(array)));
}
        ...
        if (exec_1 && preservedContexts) {
          ...
          resolvedActionObject = (0, _tslib.__assign)((0, _tslib.__assign)({}, resolvedActionObject), {
            exec: function (_ctx) {
              ...
              exec_1.apply(void 0, (0, _tslib.__spreadArray)([preservedContexts[contextIndex_1]], (0, _tslib.__read)(args)));
            }
          });
        }
...
},{"./_virtual/_tslib.js":"../node_modules/xstate/es/_virtual/_tslib.js","./utils.js":"../node_modules/xstate/es/utils.js","./serviceScope.js":"../node_modules/xstate/es/serviceScope.js"}],"../node_modules/xstate/es/invokeUtils.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _context // TODO: this is unsafe, but we're removing it in v5 anyway
    ...
    this.id = this.config.id || (0, _tslib.__spreadArray)([this.machine.key], (0, _tslib.__read)(this.path)).join(this.delimiter);
    ...
    try {
      for (var _b = (0, _tslib.__values)(this.getCandidates(eventName)), _c = _b.next(); !_c.done; _c = _b.next()) {
        ...
        if (guardPassed && isInState) {
          ...
          actions.push.apply(actions, (0, _tslib.__spreadArray)([], (0, _tslib.__read)(candidate.actions)));
  ...
  StateNode.prototype.getActions = function (transition, currentContext, _event, prevState) {
    ...
    var _c = (0, _tslib.__read)([(0, _utils.flatten)(Array.from(entryStates).map(function (stateNode) {
      ...
      }))), (0, _tslib.__read)(stateNode.onEntry));
    })).concat(doneEvents.map(_actions.raise)), (0, _utils.flatten)(Array.from(exitStates).map(function (stateNode) {
      return (0, _tslib.__spreadArray)((0, _tslib.__spreadArray)([], (0, _tslib.__read)(stateNode.onExit)), (0, _tslib.__read)(stateNode.activities.map(function (activity) {
  ...
  StateNode.prototype.transition = function (state, event, context) {
    ...
    stateTransition.configuration = (0, _tslib.__spreadArray)([], (0, _tslib.__read)(resolvedConfig));
  ...
  StateNode.prototype.resolveRaisedTransition = function (state, _event, originalEvent) {
    ...
    (_a = state.actions).unshift.apply(_a, (0, _tslib.__spreadArray)([], (0, _tslib.__read)(currentActions)));
  ...
  StateNode.prototype.resolveTransition = function (stateTransition, currentState, _event, context) {
    ...
    var _b = (0, _tslib.__read)((0, _actions.resolveActions)(this, currentState, currentContext, _event, actions, this.machine.config.preserveActionOrder), 2),
    ...
    maybeNextState.tags = new Set((0, _utils.flatten)(maybeNextState.configuration.map(function (sn) {
      return sn.tags;
    })));
  ...
  StateNode.prototype.formatTransitions = function () {
    ...
    var invokeConfig = (0, _utils.flatten)(this.invoke.map(function (invokeDef) {
      ...
      if (invokeDef.onDone) {
        settleTransitions.push.apply(settleTransitions, (0, _tslib.__spreadArray)([], (0, _tslib.__read)((0, _utils.toTransitionConfigArray)(String((0, _actions.doneInvoke)(invokeDef.id)), invokeDef.onDone))));
      }

      if (invokeDef.onError) {
        settleTransitions.push.apply(settleTransitions, (0, _tslib.__spreadArray)([], (0, _tslib.__read)((0, _utils.toTransitionConfigArray)(String((0, _actions.error)(invokeDef.id)), invokeDef.onError))));
      }

      return settleTransitions;
    }));
    var delayedTransitions = this.after;
    var formattedTransitions = (0, _utils.flatten)((0, _tslib.__spreadArray)((0, _tslib.__spreadArray)((0, _tslib.__spreadArray)((0, _tslib.__spreadArray)([], (0, _tslib.__read)(doneConfig)), (0, _tslib.__read)(invokeConfig)), (0, _tslib.__read)(onConfig)), (0, _tslib.__read)(eventlessConfig)).map(function (transitionConfig) {
...
},{}],"../node_modules/xstate/es/behaviors.js":[function(require,module,exports) {
"use strict";
...
},{"./environment.js":"../node_modules/xstate/es/environment.js","./utils.js":"../node_modules/xstate/es/utils.js","./types.js":"../node_modules/xstate/es/types.js","./actionTypes.js":"../node_modules/xstate/es/actionTypes.js","./Actor.js":"../node_modules/xstate/es/Actor.js"}],"../node_modules/xstate/es/interpreter.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
exports.toggleMachine = xstate_1.createMachine({
  id: 'toggleButton',
  initial: 'idle',
  states: {
    idle: {
...
var xstate_1 = require("xstate"); //Anime
